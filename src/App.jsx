...
export default function PortfolioV2() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tools: ["JavaScript", "Node.js", "REST APIs", "Workflow"],
  ...
  return (
    <div className="min-h-screen text-white scroll-smooth relative overflow-x-hidden bg-[#030712]">
      {/* PREMIUM GLOBAL BACKGROUND */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div
          className="fixed w-[400px] h-[400px] rounded-full pointer-events-none blur-[120px] opacity-20 bg-cyan-500 z-0"
          style={{
            left: position.x - 200,
            top: position.y - 200,
          }}
        ...
        <div className="absolute top-[-200px] left-[-100px] w-[700px] h-[700px] bg-cyan-500/20 rounded-full blur-[160px] animate-pulse" />
        <div className="absolute top-[30%] right-[-150px] w-[650px] h-[650px] bg-purple-600/20 rounded-full blur-[180px] animate-pulse" />
        <div className="absolute bottom-[-200px] left-[20%] w-[800px] h-[800px] bg-pink-500/10 rounded-full blur-[200px]" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-72 h-72 bg-cyan-500/20 rounded-full blur-[140px] animate-pulse" />
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-purple-500/20 rounded-full blur-[150px] animate-pulse delay-700" />
        <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] border border-cyan-500/10 rounded-full animate-spin duration-[15000]" />
        <div className="absolute top-1/3 left-1/3 w-[300px] h-[300px] border border-purple-500/10 rounded-full animate-spin duration-[10000]" />
      </div>
      ...
      {/* HERO SECTION */}
      <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
        <div className="absolute inset-0 opacity-[0.06] bg-[linear-gradient(rgba(0,255,255,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(0,255,255,0.15)_1px,transparent_1px)] bg-[size:60px_60px]" />
        <div className="absolute top-20 left-0 w-96 h-96 bg-cyan-500/20 blur-[140px] rounded-full" />
        <div className="absolute right-0 bottom-0 w-[420px] h-[420px] bg-purple-500/20 blur-[170px] rounded-full" />
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4 flex-wrap">
            <a
              href="#projects"
              className="px-7 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-600 font-semibold hover:scale-105 transition"
            >
              Explore Projects
            </a>
            <a
              href="#contact"
              className="px-7 py-3 rounded-2xl border border-cyan-500/30 hover:bg-cyan-500/10 transition"
            >
              Let's Connect
            </a>
            <a
              ...
              download
              className="px-7 py-3 rounded-2xl border border-purple-500/30 hover:bg-purple-500/10 transition"
            >
              Download Resume
            </a>
          </div>
        ...
        {/* Hero Right */}
        <div className="relative z-10 flex justify-center items-start pt-16 lg:pt-24">
          <div className="flex flex-col gap-6 w-full max-w-md">
            <div className="bg-slate-900/70 border border-cyan-500/30 backdrop-blur-xl rounded-3xl p-6 hover:-translate-y-2 hover:shadow-cyan-500/20 hover:shadow-xl transition-all duration-300">
              <h3 className="font-bold text-cyan-400 text-xl">🎨 UI/UX Design</h3>
              <p className="text-slate-300 mt-3">Wireframing • User Flow • Prototyping</p>
            </div>
            ...
            <div className="bg-slate-900/70 border border-pink-500/30 backdrop-blur-xl rounded-3xl p-6 hover:-translate-y-2 hover:shadow-pink-500/20 hover:shadow-xl transition-all duration-300">
              <h3 className="font-bold text-pink-400 text-xl">🤖 AI Innovation</h3>
              <p className="text-slate-300 mt-3">RAG • Prompt Engineering • AI Systems</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 py-24">
        <div className="relative overflow-hidden rounded-[40px] border border-cyan-500/20 shadow-[0_0_60px_rgba(6,182,212,0.08)] bg-gradient-to-br from-cyan-500/10 via-slate-950 to-purple-500/10 backdrop-blur-xl p-10 lg:p-14">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-cyan-500/10 blur-[120px] rounded-full" />

          <div className="grid lg:grid-cols-[350px_1fr] gap-12 items-center">
            <div className="relative">
              <div className="absolute -inset-2 rounded-[36px] bg-gradient-to-r from-cyan-500 to-purple-500 blur-xl opacity-20" />
              <img
                src="/Portfolio profile pic.png"
                alt="Janaki"
                className="relative w-full h-[400px] object-cover object-top rounded-[32px] border border-white/10"
              />
            </div>
            ...
            <div>
              ...
              <p className="text-slate-300 text-lg leading-relaxed mb-8">
                I'm Janaki, a Computer Science student passionate about crafting meaningful digital experiences through UI/UX Design, Full Stack Development, and AI-driven innovation.
                <br /><br />
                My journey combines creativity, problem-solving, and technical execution—transforming ideas into intuitive interfaces, scalable applications, and intelligent solutions. Through internships, hackathons, and independent projects, I continuously explore new technologies, refine my skills, and build products that create real-world impact.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="education" className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto text-lg">
            My academic journey has been more than grades—it's been a foundation for creativity, technical problem-solving, product thinking, and continuous exploration of emerging technologies.
          </p>
        </div>
        ...
        <div className="space-y-8">
          {education.map((edu, index) => (
            <div
              key={edu.degree}
              className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8"
            >
              ...
              <div className="flex flex-col lg:flex-row lg:justify-between gap-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10">
                    <p className="text-slate-300 text-sm">{edu.duration}</p>
                  </div>
                </div>
              </div>
      ...
      <section id="skills" className="max-w-7xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-300 mb-10 max-w-3xl">
          A blend of design, development, AI innovation, and leadership that helps me transform ideas into impactful digital products.
        </p>
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          {skillCategories.map((category) => (
            <div
              key={category.title}
              className="bg-white/[0.04] backdrop-blur-xl rounded-3xl p-6 border border-white/15 hover:border-cyan-400/40 hover:-translate-y-2 transition shadow-xl"
            >
              ...
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-2 rounded-2xl bg-white/10 text-sm hover:bg-cyan-500/20 transition"
                  >
                    {skill}
                  </span>
                ))}
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-3xl p-8 border border-white/15 text-center shadow-xl"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <h3 className="text-4xl font-bold mb-12">How I Turn Ideas Into Products</h3>
        <div className="relative">
          <div className="absolute top-12 left-0 w-full h-[2px] bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500" />
          <div className="grid md:grid-cols-5 gap-6">
            {[
              { title: "Discover", icon: "🔍", desc: "Understand users, problems and opportunities." },
              { title: "Define", icon: "🎯", desc: "Translate insights into product direction." },
              { title: "Design", icon: "🎨", desc: "Create intuitive and scalable experiences." },
              { title: "Develop", icon: "⚡", desc: "Build robust and functional solutions." },
              { title: "Refine", icon: "🚀", desc: "Iterate, optimize and improve outcomes." },
            ].map((step) => (
              <div
                key={step.title}
                className="relative bg-white/[0.04] backdrop-blur-xl rounded-3xl p-6 border border-white/15 hover:border-cyan-400/40 transition"
              >
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 flex items-center justify-center text-xl mb-4">
                  {step.icon}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="relative overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-br from-cyan-500/10 via-slate-950 to-purple-500/10 backdrop-blur-xl p-10">
          ...
          <p className="text-slate-300 text-lg max-w-4xl leading-relaxed mb-8">
            Beyond my current projects, I actively explore modern technologies, development frameworks, AI-driven systems, cybersecurity concepts, and product innovation practices. I enjoy learning through experimentation, hackathons, internships, research, and hands-on implementation—continuously expanding my capabilities to design and build impactful digital solutions.
          </p>
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span
                key={item}
                className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-slate-300 hover:border-cyan-400/40 hover:text-cyan-300 transition"
              >
                {item}
              </span>
            ))}
      ...
      {/* CONTACT SECTION */}
      <section id="contact" className="relative max-w-7xl mx-auto px-6 py-28 overflow-hidden">
        <div className="relative rounded-[40px] border border-white/10 bg-gradient-to-br from-cyan-500/10 via-slate-950 to-purple-500/10 backdrop-blur-2xl overflow-hidden p-10 lg:p-16">
          <div className="absolute top-[-120px] right-[-100px] w-[320px] h-[320px] rounded-full bg-cyan-500/20 blur-[120px]" />
          <div className="absolute bottom-[-120px] left-[-100px] w-[320px] h-[320px] rounded-full bg-purple-500/20 blur-[130px]" />
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center relative z-10">
            ...
            <div>
              ...
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl mb-10">
                Open to internships, collaborations, hackathons and creative product opportunities in UI/UX, AI and software development. If you're building something exciting—I’d love to be part of it.
              </p>

              <div className="flex flex-wrap gap-4">
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=janakig.mvgrce24@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-7 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-600 font-semibold hover:scale-105 transition shadow-xl inline-block"
                >
                  Send Email
                </a>
                ...
                <a
                  href="/JANAKI_GADU_RESUME.pdf"
                  download
                  className="px-7 py-3 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition"
                >
                  Download Resume
                </a>
              </div>
            ...
            <div className="space-y-5">
              <a
                ...
                className="group block rounded-3xl p-6 bg-white/[0.04] border border-white/10 hover:border-cyan-400/40 hover:-translate-y-2 transition-all duration-300"
              >
                <p className="text-sm text-slate-400 mb-2">EMAIL</p>
                <h4 className="text-xl font-semibold group-hover:text-cyan-300 transition">
